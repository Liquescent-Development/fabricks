    ...
    pub mod wasi {
        pub mod http {
            ...
            pub mod incoming_handler {
                ...
                #[doc(hidden)]
                pub(crate) use __export_wasi_http_incoming_handler_0_2_9_cabi;
            }
        }
    }
}
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_hello_http_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_hello_http_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:hello-http:hello-http:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7055] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x8e6\x01A\x02\x01A#\x01\
...
\0\x06handle\x01\x06\x04\0\x20wasi:http/incoming-handler@0.2.9\x05\x16\x04\0\x1f\
component:hello-http/hello-http\x04\0\x0b\x10\x01\0\x0ahello-http\x03\0\0\0G\x09\
